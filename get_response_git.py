...
def response(tweet, tweet_ID):
    ...
    sentences=pandas.read_pickle("PROCESSED TEXT FILE")
    ...
    responses_used=pandas.read_csv("HISTORICAL RECORD OF RESONSES AND TWEETS")    
    ...
    #record used response
        ...
        responses_used.to_csv("C:/Users/me/Documents/Python Scripts/bot/responses_used.csv", index=False)
